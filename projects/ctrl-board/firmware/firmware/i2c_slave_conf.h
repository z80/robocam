...
#define CMD_CURRENT_TIME        6
#define CMD_SET_WAKEUPS_CNT     7
#define CMD_SET_WAKEUP          8
#define CMD_TEMP                9
#define CMD_CURR                10
#define CMD_SET_SOLAR_VOLT      11
#define CMD_SET_CHARGE_VOLT     12
#define CMD_SET_MOTO_EN         13
#define CMD_SET_MOTO            14
#define CMD_SET_LIGHT           15
#define CMD_SET_LED             16
#define CMD_BUCK_FB             17
#define CMD_BOOST_FB            18
#define CMD_SOLAR_FB            19
// Commands for power oscilloscope.
#define CMD_SETUP_OSC           20 // 2 bytes period in seconds, 1 byte what to measure: current, temperature.
#define CMD_OSC_STATUS          21 // 2 bytes number of measures in memory and 1 byte signals measured.
#define CMD_OSC                 22 // Get value/values by index. 0 - most recent, 1 - previous, 2 - prev-previous.
// To be continued.
// .....
