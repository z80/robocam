...
RTCD_EXTERN void (*vp9_mb_lpf_horizontal_edge_w)(uint8_t *s, int pitch, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_SSE2) vp9_variance_halfpixvar16x16_h = vp9_variance_halfpixvar16x16_h_wmt;

    vp9_variance_halfpixvar16x16_v = vp9_variance_halfpixvar16x16_v_c;
    if (flags & HAS_SSE2) vp9_variance_halfpixvar16x16_v = vp9_variance_halfpixvar16x16_v_wmt;

    vp9_variance_halfpixvar16x16_hv = vp9_variance_halfpixvar16x16_hv_c;
    if (flags & HAS_SSE2) vp9_variance_halfpixvar16x16_hv = vp9_variance_halfpixvar16x16_hv_wmt;
    ...
    if (flags & HAS_SSE2) vp9_mse16x16 = vp9_mse16x16_wmt;
